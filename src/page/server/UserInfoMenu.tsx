...
export default function UserInfoMenu() {
  ...
  return (
    <div
      className={
        "absolute bottom-0 mt-auto flex h-14 w-full items-center bg-customDark_1 px-2 py-2 text-customText"
      }
    >
      ...
      {isHover ? (
        <div
          style={{ top: "-28px", right: "-22px" }}
          className={"absolute rounded bg-black px-2 py-1 text-sm"}
        >
          사용자 설정
        </div>
      ) : null}
