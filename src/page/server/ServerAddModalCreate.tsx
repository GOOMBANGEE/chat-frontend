    ...
    >
      ...
      <div className={"flex flex-col px-4 py-2 text-start text-gray-400"}>
        ...
        <input
          ...
          className={"w-full rounded bg-customGray px-2 py-2 text-white"}
        />
        {serverAddState.name ? (
          <button
            onClick={() => handleCreateButtonClick()}
            className={
              "ml-auto mt-4 w-24 rounded bg-indigo-500 py-2 text-sm text-white"
            }
          >
            만들기
          </button>
          ...
          <div
            className={
              "ml-auto mt-4 w-24 rounded bg-indigo-500 py-2 text-center text-sm text-white opacity-50"
            }
          >
            만들기
          </div>
      ...
      >
        ...
        <button
          ...
          className={"w-full rounded bg-customGray py-2 text-sm"}
        >
          서버 참가하기
        </button>
      </div>
